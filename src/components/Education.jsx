...
const Education = () => {
  return (
    <section id="education" className="border-b border-neutral-900 mb-4">
      <h2 className="lg:my-20 my-8 text-center text-4xl font-bold">
        Education
      </h2>
      <div>
          ...
          <div key={index} className="mb-8 flex flex-wrap justify-center py-5">
            ...
            >
              <img
                ...
                className="rounded-lg lg:h-[300px] border border-neutral-400"
              />
            </motion.div>
            <div className="w-full max-w-xl lg:w-2/3 py-8">
              <motion.h2
                variants={fadeInVariants}
                initial="hidden"
                whileInView="visible"
                className="mb-3 text-lg font-bold text-neutral-100 tracking-wide"
              >
                {edu.course} -{" "}
              ...
              >
                <span className="rounded bg-neutral-900 px-2 py-1 text-md font-medium text-green-400">
                  Score: {edu.marks[1]}
                </span>
                <span className="rounded bg-neutral-900 px-2 py-1 text-md font-medium text-green-400">
                  Grade: {edu.marks[0]}
